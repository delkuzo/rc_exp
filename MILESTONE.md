...
- [x] Создание базовых контроллов
  - [x] Компонент Tabs (вкладки) - создан и интегрирован в навигацию
...
**Выполнено:** 2.3 из 5 этапов (46%)
**Текущий этап:** Этап 2 - Создание UI Kit в коде
**Следующая задача:** Переход к этапу экспериментов
